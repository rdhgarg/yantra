...
<div class="app-content">
    <div class="side-app">
        ...
        <!--  Start Content -->
    <form id="submitForm" class="row"  method="post" action="<?php echo e(route('brand-save')); ?>">
							...
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header">
										<h3 class="card-title">Brand Forms</h3>
									</div>
									<div class="card-body">
									    ...
									    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 ">
                                                <img id="FileImg" src="<?php echo e(url('public/uploads/brand/default_image.png')); ?>" style="width: 100px;height: 100px">
                                                </div>
                                            </div>
                                         </div>
           ...
           $('#submitForm').submit(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
						var btn = '<a href="<?php echo e(route('brand-list')); ?>" class="btn btn-info btn-sm">GoTo List</a>';
                        successMsg('Create brand', data.msg, btn);
                        $('#submitForm')[0].reset();
                        ...
                        errorMsg('Create brand','Input error');
                    }
                    buttonLoading('reset', $this);

                },
                error: function() {
                    errorMsg('Create brand', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/stichspares/resources/views/admin/brand/brand-create.blade.php ENDPATH**/ ?>