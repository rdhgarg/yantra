                    ...
                    <div class="row">
                        ...
                        <div class="row" style="display: flex">
                            <div class="col-md-3" style=" border: solid 1px #000;margin: 10px;font-weight:bold;">
                                <input type="radio" name="date"  value="<?php echo \Carbon\Carbon::today()->subDays(0)->format('d-m-Y'); ?>" onclick="getDate('<?php echo \Carbon\Carbon::today()->subDays(0); ?>')"><span style="margin-left: 10px;"> <?php echo $date = \Carbon\Carbon::today()->subDays(0)->format('d-m-Y');?></span>
                            </div>
                            <div class="col-md-3" style=" border: solid 1px #000;margin: 10px;font-weight:bold;">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\joyflier\resources\views/front/checkout.blade.php ENDPATH**/ ?>