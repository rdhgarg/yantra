...
<h1 class="page-title">Edit Charges</h1>
<ol class="breadcrumb">
        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="<?php echo e(route('charges-update', $post->id)); ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12">
											...
											<input type="text" class="form-control"  value="<?php echo e($post->title); ?>" name="title" id="title">
                                        </div>

                                        <div class="form-group col-sm-12">
											<label class="form-label">To Distance (Km)</label>
											<input type="text" class="form-control" value="<?php echo e($post->to_distance); ?>" name="to_distance" id="to_distance">
                                        </div>

                                        <div class="form-group col-sm-12">
											<label class="form-label">From Distance (Km)</label>
											<input type="text" class="form-control" value="<?php echo e($post->from_distance); ?>" name="from_distance" id="from_distance">
                                        </div>

                                        <div class="form-group col-sm-12">
											<label class="form-label">Price</label>
											<input type="text" class="form-control" value="<?php echo e($post->price); ?>" name="price" id="price">
                                        </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\joyflier\resources\views/admin/charges/charges-edit.blade.php ENDPATH**/ ?>