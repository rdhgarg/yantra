        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="<?php echo e(route('banner-store')); ?>">
                                    ...
                                    <div class="row">
										...
										<div class="form-group col-sm-12"  style='display:none'>
											...
											<input type="text" class="form-control" name="link" id="link" value='no@gmail.com' style='display:none'>
                                        </div>
										<div class="form-group col-sm-12">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/stichspares/resources/views/admin/banner/banner-create.blade.php ENDPATH**/ ?>