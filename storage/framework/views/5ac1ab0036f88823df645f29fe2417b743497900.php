...
<title>Edit Offers Banner</title>
...
<h1 class="page-title">Edit Offers Banner</h1>
<ol class="breadcrumb">
        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="<?php echo e(route('offersbanner-update', $post->id)); ?>">
                                    ...
                                    <div class="row">
										...
										<div class="form-group col-sm-6">
											...
											<?php if($post->banner): ?>
												<img src="<?php echo e(url('/public/'.$post->banner)); ?>" style="width:200px margin-top:15px; height:200px">
											<?php endif; ?>
                                        </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\joyflier\resources\views/admin/offers/offersbanner-edit.blade.php ENDPATH**/ ?>