                            ...
                            <div class="card-body tab-content">
                                ...
                                <div class="tab-pane" id="Addresses">
                                    <div class="row">
                                        ...
                                        <button type='button' class='btn btn-info' id='addressbtn' style='background-color:#1F1F78 !important;padding-bottom:10px;margin-left:15px'> Add address </button>

                                        <div class="card-body addressdiv" style='display:none;padding-top:10px'>
                                            <div class="shipping_form_outer">
                                                  <form id='add_address' action="<?php echo e(route('add_address')); ?>" method="POST" style='border:solid 1px #ccc;padding:30px'>
                                                    <?php echo csrf_field(); ?>
                                                    <div class="col-md-12">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="butt">
                                                                    <button class='btn btn-success' type='submit' data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please wait..." data-rest-text="Add address" id='submitButton'>Save</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    function updateprofile(){
        ...
        $.ajax({
            ...
            function add_address(){
                ...
                var url = $("#add_address").attr('action');
            ...
            $(document).on('click','.edit_address',function(){
                ...
                $.ajax({
                    dataType:'json',
                    url:"<?php echo e(route('edit_address')); ?>",
                    type:'POST',
                    ...
                    success:function(d){
                        if(d.status){
                            ...
                            $(".addressdiv").show();
                            $("#add_address").attr('action',d.url);
                            $("#first_name").val(d.data.first_name);
                            $("#state").val(d.data.state);
                            $("#pincode").val(d.data.pincode);
                            $("#city").val(d.data.city);
                            $("#address").val(d.data.address);
                            $("#alternative").val(d.data.alternative);
                            $("#last_name").val(d.data.last_name);
                            $("#customer_phone").val(d.data.customer_phone);
                            $("#email_id").val(d.data.email_id);
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\joyflier\resources\views/front/account.blade.php ENDPATH**/ ?>