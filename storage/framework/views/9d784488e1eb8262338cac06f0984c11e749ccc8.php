        ...
        <!-- COL END -->
							<div class="col-lg-6">
								<div class="card">
									...
									<div class="card-body">
									    <form id="submitForm"  method="post" action="<?php echo e(route('save-user')); ?>">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\yantra\resources\views/admin/users/vendor-create.blade.php ENDPATH**/ ?>