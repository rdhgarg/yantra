                    ...
                    <div class="card-header">
                        ...
                        <div class="ml-auto pageheader-btn">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('brand Create')): ?>
								<a href="<?php echo e(route('brand-create')); ?>" class="btn btn-success btn-icon text-white mr-2">
									<span>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('brand-list')); ?>",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
            ...
            $(document).on('click','.viewDetail', function(){
                 var con = confirm("Are You Sure Want to Delete This Brand");
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/stichspares/resources/views/admin/brand/brand.blade.php ENDPATH**/ ?>