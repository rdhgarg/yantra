								...
								<div class="card">
                                    ...
                                    <div class="row">
										...
										<div class="form-group col-sm-12">
											...
											<?php if($post->banner): ?>
												<img src="<?php echo e($post->banner); ?>" style="width:200px margin-top:15px; height:200px">
											<?php endif; ?>
                                        </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\joyflier\resources\views/admin/banner/banner-edit.blade.php ENDPATH**/ ?>