                        ...
                        <table class="table table-bordered data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('user-edit',$val->id)); ?>" class="edit btn btn-primary btn-sm">Edit</a> <a href="<?php echo e(route('view-user',$val->id)); ?>" class="edit btn btn-primary btn-sm viewDetail">view</a></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\yantra\resources\views/admin/users/vendor.blade.php ENDPATH**/ ?>