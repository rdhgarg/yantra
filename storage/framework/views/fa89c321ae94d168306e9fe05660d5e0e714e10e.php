        ...
        <!-- COL END -->
							<div class="col-lg-6">
								<div class="card">
									...
									<div class="card-body">
									    <form id="submitForm"  method="post" action="<?php echo e(route('update-vendor',$post->id)); ?>">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/androidhiker/public_html/stichspares/resources/views/admin/users/vendor-edit.blade.php ENDPATH**/ ?>